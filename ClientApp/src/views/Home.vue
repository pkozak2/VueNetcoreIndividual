  ...
  <div>
    ...
    <div>
      ...
      <ul>
        ...
        <li>
          <strong>Vue.js CLI integration</strong>. In development mode, there's
          no need to run <code>vue-cli-service serve serve</code>. It runs in
          the background automatically, so your client-side resources are
        ...
        <li>
          ...
          <code>vue-cli-service build</code> to produce minified, ahead-of-time
          compiled JavaScript files.
        </li>
      </ul>
      <p>
        The
        <code>ClientApp</code> subdirectory is a standard Vue.js CLI
        application. If you open a command prompt in that directory, you can run
        any <code>vue-cli-service</code> command (e.g.,
        <code>vue-cli-service serve</code>), or use <code>npm</code> to install
